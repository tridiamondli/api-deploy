...
async def lifespan(app: FastAPI):
    ...
    for module_name, functions in registered_funcs.items():
        for func_name in functions.keys():
            api_logger.info(f"   POST /{module_name}/{func_name}")
...
async def root():
    ...
    for module_name, functions in registered_funcs.items():
        for func_name in functions.keys():
            endpoints.append(f"POST /{module_name}/{func_name}")
